...
var React3, import_react, isBrowser2, hasOwnProperty, EmotionCacheContext, CacheProvider, withEmotionCache, ThemeContext, getTheme, createCacheWithTheme, typePropName, labelPropName, Insertion, Emotion;
...
var require_spacing = __commonJS({
  "node_modules/@mui/system/spacing.js"(exports) {
    ...
    function getStyleFromPropValue2(cssProperties, transformer2) {
      return (propValue) => cssProperties.reduce((acc, cssProperty) => {
        acc[cssProperty] = getValue2(transformer2, propValue);
        return acc;
      }, {});
    }
    function resolveCssProperty2(props, keys, prop, transformer2) {
      if (keys.indexOf(prop) === -1) {
        return null;
      }
      const cssProperties = getCssProperties2(prop);
      const styleFromPropValue = getStyleFromPropValue2(cssProperties, transformer2);
      const propValue = props[prop];
      return (0, _breakpoints.handleBreakpoints)(props, propValue, styleFromPropValue);
    }
    function style4(props, keys) {
      const transformer2 = createUnarySpacing2(props.theme);
      return Object.keys(props).map((prop) => resolveCssProperty2(props, keys, prop, transformer2)).reduce(_merge.default, {});
    }
  ...
  "node_modules/@mui/system/borders.js"(exports) {
    ...
    var borderRadius2 = (props) => {
      if (props.borderRadius !== void 0 && props.borderRadius !== null) {
        const transformer2 = (0, _spacing.createUnaryUnit)(props.theme, "shape.borderRadius", 4, "borderRadius");
        const styleFromPropValue = (propValue) => ({
          borderRadius: (0, _spacing.getValue)(transformer2, propValue)
        });
  ...
  "node_modules/@mui/system/cssGrid.js"(exports) {
    ...
    var gap2 = (props) => {
      if (props.gap !== void 0 && props.gap !== null) {
        const transformer2 = (0, _spacing.createUnaryUnit)(props.theme, "spacing", 8, "gap");
        const styleFromPropValue = (propValue) => ({
          gap: (0, _spacing.getValue)(transformer2, propValue)
        });
    ...
    var columnGap2 = (props) => {
      if (props.columnGap !== void 0 && props.columnGap !== null) {
        const transformer2 = (0, _spacing.createUnaryUnit)(props.theme, "spacing", 8, "columnGap");
        const styleFromPropValue = (propValue) => ({
          columnGap: (0, _spacing.getValue)(transformer2, propValue)
        });
    ...
    var rowGap2 = (props) => {
      if (props.rowGap !== void 0 && props.rowGap !== null) {
        const transformer2 = (0, _spacing.createUnaryUnit)(props.theme, "spacing", 8, "rowGap");
        const styleFromPropValue = (propValue) => ({
          rowGap: (0, _spacing.getValue)(transformer2, propValue)
        });
...
function useCurrentColorScheme(options) {
  ...
  const setMode = React27.useCallback((mode2) => {
...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider2({
    ...
    const ctx2 = React28.useContext(ColorSchemeContext);
...
var useChartDimensions = (width2, height2, margin2) => {
  ...
  const drawingArea = React34.useMemo(() => ({
...
var DrawingContext = React35.createContext({
  top: 0,
  left: 0,
  bottom: 0,
  right: 0,
...
var SVGContext = React35.createContext({
  current: null
});
...
var SeriesContext = React36.createContext({});
...
function SeriesContextProvider(props) {
  ...
  const formattedSeries = React36.useMemo(() => formatSeries(series, typeof colors3 === "function" ? colors3(theme.palette.mode) : colors3, dataset), [series, colors3, theme.palette.mode, dataset]);
...
var InteractionContext = React37.createContext({
  item: null,
  axis: {
    x: null,
    y: null
...
function InteractionProvider(props) {
  ...
  const [data, dispatch] = React37.useReducer(dataReducer, {
    item: null,
    axis: {
      x: null,
      y: null
  ...
  const value = React37.useMemo(() => _extends({}, data, {
    dispatch
  }), [data]);
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react16.forwardRef)((givenProps, givenRef) => {
    ...
    return React38.createElement(Component, { ...usedProps, ref });
  });
};
...
var SpringContext = ({
  ...
  const { Provider } = ctx;
  return React39.createElement(Provider, { value: props }, children);
};
var ctx = makeContext(SpringContext, {});
SpringContext.Provider = ctx.Provider;
SpringContext.Consumer = ctx.Consumer;
function makeContext(target, init) {
  Object.assign(target, React39.createContext(init));
...
var CartesianContext = React41.createContext({
  xAxis: {},
  yAxis: {},
  xAxisIds: [],
  yAxisIds: []
...
function CartesianContextProvider(props) {
  ...
  const formattedSeries = React41.useContext(SeriesContext);
  const drawingArea = React41.useContext(DrawingContext);
  const xAxis = React41.useMemo(() => inXAxis == null ? void 0 : inXAxis.map((axisConfig) => {
  ...
  const yAxis = React41.useMemo(() => inYAxis == null ? void 0 : inYAxis.map((axisConfig) => {
    const dataKey = axisConfig.dataKey;
    if (dataKey === void 0 || axisConfig.data !== void 0) {
      return axisConfig;
    }
...
var useAxisEvents = (disableAxisListener) => {
  const svgRef = React42.useContext(SVGContext);
  const {
    width: width2,
    height: height2,
    top: top3,
  ...
  const mousePosition = React42.useRef({
    x: -1,
    y: -1
  });
  React42.useEffect(() => {
...
var ChartsSurface = React43.forwardRef(function ChartsSurface2(props, ref) {
  const {
    children,
    width: width2,
    height: height2,
...
var HighlighContext = React44.createContext({
  item: null,
  scope: defaultScope,
  dispatch: () => null
});
...
function HighlightProvider(props) {
  ...
  const [data, dispatch] = React44.useReducer(dataReducer2, {
    item: null,
    scope: defaultScope
  });
  const value = React44.useMemo(() => _extends({}, data, {
    dispatch
  }), [data]);
...
var ChartContainer = React45.forwardRef(function ChartContainer2(props, ref) {
  const {
    width: width2,
    height: height2,
    series,
  ...
  const svgRef = React45.useRef(null);
...
var ResponsiveChartContainer = React46.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    width: inWidth,
    height: inHeight
...
var ClassNameConfiguratorContext = React47.createContext(defaultContextValue);
if (true) {
...
function useClassNamesOverride(generateUtilityClass3) {
  ...
  } = React47.useContext(ClassNameConfiguratorContext);
  return (slot) => {
...
function ChartsXAxis(inProps) {
  ...
  const _React$useContext = React52.useContext(CartesianContext), _ref = (_props$axisId = props.axisId) != null ? _props$axisId : xAxisIds[0], {
    xAxis: {
      [_ref]: {
        scale: xScale,
        tickNumber,
...
var _excluded25 = ["scale", "tickNumber"];
...
function ChartsYAxis(inProps) {
  ...
  const _React$useContext = React53.useContext(CartesianContext), _ref = (_props$axisId = props.axisId) != null ? _props$axisId : yAxisIds[0], {
    yAxis: {
      [_ref]: {
        scale: yScale,
        tickNumber
  ...
  } = _React$useContext, settings = _objectWithoutPropertiesLoose(_React$useContext.yAxis[_ref], _excluded25);
...
function ChartsAxis(props) {
  ...
  const {
    ...
    yAxis,
    yAxisIds
  } = React54.useContext(CartesianContext);
...
var Portal = React55.forwardRef(function Portal2(props, forwardedRef) {
  const {
    children,
    container,
    disablePortal = false
  ...
  const handleRef = useForkRef(React55.isValidElement(children) ? children.ref : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React55.isValidElement(children)) {
      ...
      return React55.cloneElement(children, newProps);
    }
    return (0, import_jsx_runtime31.jsx)(React55.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime31.jsx)(React55.Fragment, {
...
function useMouseTracker() {
  const svgRef = React58.useContext(SVGContext);
  const [mousePosition, setMousePosition] = React58.useState(null);
  React58.useEffect(() => {
    const element = svgRef.current;
    if (element === null) {
      return () => {
...
function ChartsItemTooltipContent(props) {
  ...
  const series = React60.useContext(SeriesContext)[itemData.type].series[itemData.seriesId];
...
function ChartsAxisTooltipContent(props) {
  ...
  const series = React63.useContext(SeriesContext);
  const USED_AXIS_ID = isXaxis ? xAxisIds[0] : yAxisIds[0];
  const relevantSeries = React63.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React63.useMemo(() => {
...
var _excluded29 = ["rotate", "dominantBaseline"];
...
function DefaultChartsLegend(props) {
  ...
  const padding2 = React65.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React65.useCallback((label, inStyle = {}) => {
    const style4 = _objectWithoutPropertiesLoose(inStyle, _excluded29);
  ...
  const seriesWithPosition = React65.useMemo(() => {
    let x2 = 0;
    let y2 = 0;
...
function ChartsLegend(inProps) {
  ...
  const drawingArea = React65.useContext(DrawingContext);
  const series = React65.useContext(SeriesContext);
...
function ChartsAxisHighlight(props) {
  ...
  const {
    ...
    yAxisIds,
    yAxis
  } = React67.useContext(CartesianContext);
...
var useInteractionItemProps = (scope) => {
  ...
  } = React68.useContext(InteractionContext);
  const {
    dispatch: dispatchHighlight
  } = React68.useContext(HighlighContext);
...
var _excluded30 = ["id", "dataIndex", "classes", "color", "highlightScope", "onClick", "isFaded", "isHighlighted", "startAngle", "endAngle", "paddingAngle", "innerRadius", "outerRadius", "cornerRadius"];
...
function useTransformData(series) {
  ...
  const getHighlightStatus = React70.useCallback((dataIndex) => {
  ...
  const dataWithHighlight = React70.useMemo(() => data.map((item, itemIndex) => {
...
var _excluded31 = ["slots", "slotProps", "innerRadius", "outerRadius", "cornerRadius", "paddingAngle", "id", "highlightScope", "highlighted", "faded", "data", "onClick", "skipAnimation"];
...
var _excluded33 = ["id", "classes", "color", "startAngle", "endAngle", "paddingAngle", "arcLabelRadius", "innerRadius", "outerRadius", "cornerRadius", "formattedArcLabel", "isHighlighted", "isFaded", "style"];
...
var _excluded34 = ["slots", "slotProps", "innerRadius", "outerRadius", "arcLabelRadius", "cornerRadius", "paddingAngle", "id", "highlightScope", "highlighted", "faded", "data", "arcLabel", "arcLabelMinAngle", "skipAnimation"];
...
function PiePlot(props) {
  ...
  const seriesData = React74.useContext(SeriesContext).pie;
  const {
    left: left3,
    top: top3,
    width: width2,
    height: height2
  } = React74.useContext(DrawingContext);
